...
class Advisor(Staff):
    ...
    def reject_student(self, student, selections):
        try:
            ...
            raise ValueError("Input must only include numbers. Please try again.")
