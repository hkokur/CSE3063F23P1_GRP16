...
from models import Transcript  # Assuming Transcript class is in a separate file
from models import Grade  # Assuming Grade class is in a separate file
from models import TimeInterval  # Assuming TimeInterval class is in a separate file
from utils import DataUtils  # Assuming DataUtils class is in a separate file
from menus import Menu  # Assuming Menu class is in a separate file
